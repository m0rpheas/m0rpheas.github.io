...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]M0rph[/B][/COLOR]Wizard'
BUILDERNAME = 'M0rpheas'
EXCLUDES = [ADDON_ID, 'repository.m0rphwizard']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]M0rph[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing M0rphWizard.\n\nContact us on Github at http://www.github.com/m0rpheas/plugin.program.m0rphwizard/'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]M0rph[/B][/COLOR]Wizard'
